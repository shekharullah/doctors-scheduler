...
Seq[Any](format.raw/*1.71*/("""Hello, """),_display_(/*1.79*/name),format.raw/*1.83*/(""",


You recently signed up for Doctors Scheduler.

To activate your account, follow this link now:
"""),_display_(/*7.2*/verificationUrl),format.raw/*7.17*/("""

"""),format.raw/*9.1*/("""Cheers,
The DoctorsScheduler Team"""))}
  }
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: F:/Shekhar/play project/doctorscheduler/play-authenticate-mongo-master/app/views/account/signup/email/verify_email_en.scala.txt
                  HASH: 782610e4de73ed6b884da0bf03358ffabf6b04dc
                  MATRIX: 769->1|925->70|959->78|983->82|1108->182|1143->197|1171->199
